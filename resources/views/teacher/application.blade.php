                    ...
                    <div class="col-md-3">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="card-description">Apply for a course in <b>{{ $department->department_name }}</b> Department</p>
                                <form class="forms-sample" method="POST" action="{{ route('teacher.application') }}">
                                    @csrf
                                        ...
                                        <tbody>
                                            @foreach($pendingApplications as $key => $application)
                                                <tr class="text-center">
                                                    ...
                                                    <td>
                                                        <form method="POST" action="{{ route('teacher.application.delete') }}" onsubmit="return confirm('Are you sure you want to cancel this application?')">
                                                            @csrf
                                                            <input type="hidden" name="teach_id" value="{{ $application->id }}">
