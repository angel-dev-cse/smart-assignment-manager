                            ...
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade show active" id="courses" role="tabpanel" aria-labelledby="courses-tab">
                                    ...
                                    <div class="card card-shadow">
                                        <div class="card-body">
                                            <h4 class="card-title">{{ __('Active Courses') }}</h4>
                                            <p class="card-description">{{ Auth::user()->teacher->department->department_name }}</p>
                                            <div class="row">
                                                                ...
                                                                <div class="card-body">
                                                                    <div class="d-flex flex-row align-items-start">
                                                                        ...
                                                                        <div class="ms-3">
                                                                            ...
                                                                            <p class="mt-2 text-white text-left card-text">{{ $course->course_code }}</p>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
